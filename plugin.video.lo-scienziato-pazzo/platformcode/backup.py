...
temp_path = unicode(xbmc.translatePath("special://userdata/addon_data/plugin.video.lo-scienziato-pazzo/temp/"))
videolibrary_temp_path = unicode(xbmc.translatePath("special://userdata/addon_data/plugin.video.lo-scienziato-pazzo/temp/videolibrary"))

...
def execute():
    ...
    if config.get_setting('new_search'):
        xbmc.executebuiltin("RunPlugin(plugin://plugin.video.lo-scienziato-pazzo/?" + itemurl + ")")
    else:
        xbmc.executebuiltin("Container.Update(plugin://plugin.video.lo-scienziato-pazzo/?" + itemurl + ")")
